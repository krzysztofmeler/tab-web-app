  ...
  return (
    <Flex maw={900} mx="auto" py={50} direction="column" gap={20}>
      ...
      <Card style={{ boxShadow: '0 0 30px 0 rgba(0, 0, 0, 0.15)' }}>
        <Button maw={200} component={Link} to="/administration/tags">
          Tags
        </Button>
        <Space h={20} />
        <Button maw={200} component={Link} to="/administration/units">
          Units
        </Button>
        <Space h={20} />
        <Button maw={200} component={Link} to="/administration/ingredients">
          Ingredients
        </Button>
      </Card>
    </Flex>
