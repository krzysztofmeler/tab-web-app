            ...
            <Flex gap={10} direction="column">
              {steps.map((step, index) => (
                <Flex gap={8} align="start" key={index}>
                  ...
                  />
                  <Button disabled={disableForm} onClick={() => deleteStep(index)} variant="light">
                    <IconTrash size={18} />
                  </Button>
                </Flex>
              ))}
              <Button disabled={disableForm} maw={130} onClick={addStep}>
                Add step
              </Button>
            </Flex>
          </Fieldset>
              ...
              {ingredients.map((ingredient, index) => (
                <Flex gap={8} align="start" key={index}>
                  <Select
                    ...
                    allowDeselect={false}
                    onChange={(value) => updateIngredientSelection(index, value as string)}
                  ...
                  <NumberInput
                    ...
                    onChange={(e) => updateIngredientAmount(index, e as number)}
                  />
                  <Select
                    w="20%"
                    disabled={disableForm}
                    ...
                    allowDeselect={false}
                    onChange={(value) => updateIngredientUnit(index, value as string)}
                  ...
                  />
                  <Button onClick={() => deleteIngredient(index)} disabled={disableForm} variant="light">
                    <IconTrash size={18} />
                  </Button>
                </Flex>
              ))}
              <Button disabled={disableForm} maw={170} onClick={addIngredient}>
                Add ingredient
              </Button>
            </Flex>
          </Fieldset>
